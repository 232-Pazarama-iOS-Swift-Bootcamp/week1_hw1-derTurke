...
final class Menu {
    ...
    var cart = [Cart]()
    var products = [
        Product(id: UUID().uuidString, name: "Çekic", categories: ["Boyacı","Marangoz","Duvar Ustası"], seller: "Gürhan Yuvarlak", point: 9.1, price: 100.0, comment: ["Çok güzel bir ürün.","Mükemmel Bir ürün"]),
